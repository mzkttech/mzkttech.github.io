...
const database = {
home: {
ja: '<h1 class="page-h">HELLO.


SYSTEM v4</h1><p>MZKT.TECH 2026 アーカイブ。この空間は、全ての情報がプログラムによって整理・記録されています。</p>',
en: '<h1 class="page-h">HELLO.


SYSTEM v4</h1><p>Welcome to MZKT.TECH. All information is organized and recorded by the system.</p>',
zh: '<h1 class="page-h">你好。


系统 v4</h1><p>欢迎来到 MZKT.TECH。所有信息均由系统整理和记录。</p>'
},
works: {
